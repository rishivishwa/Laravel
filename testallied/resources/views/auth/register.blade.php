...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8" style="margin-top:5em;">
            <div class="card">
                <div class="card-header  align-items-center text-center" ><span style="font-size: 25px;">{{ __('Register') }} </span><br> have you already registered? <a href="login">log in</a>  </div>
